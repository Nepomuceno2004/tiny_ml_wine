...
#include "wine_dataset.h"          // Contém wine_features[144][13] e wine_labels[144]
#include "wine_normalization.h"    // Contém os vetores wine_means[13] e wine_stds[13]

#define NUM_SAMPLES 144            // Total de amostras no dataset wine
...
int main() {
    ...
    printf("Iniciando inferencia nas 144 amostras do dataset wine...\n");
     ...
     * Percorre todas as 144 amostras do dataset wine.
     */
